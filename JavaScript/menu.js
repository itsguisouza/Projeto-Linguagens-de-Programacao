...
// Selecionando o botão menu pelo seu ID utilizando 'const' para não
 ...
 * @param {Event} - Evento que dispara a função, como 'click' ou
  'touchstart*
 */
function toggleMenu(event) {
    //Evita o comportamento padrão do evento 'touchstart', evitando o bug em dispositivos móveis
